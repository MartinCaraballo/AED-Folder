...
public class TClasificador {
    ...
    public static final int METODO_CLASIFICACION_SHAKERSORT = 9;
    ...
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion) {
        switch (metodoClasificacion) {
            ...
            case METODO_CLASIFICACION_SHAKERSORT:
                return ordenarPorShakerSort(datosParaClasificar);
            default:
    ...
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion, boolean cascara) {
        switch (metodoClasificacion) {
            ...
            case METODO_CLASIFICACION_SHAKERSORT -> {
                if (cascara) {
                    return ordenarPorShakerSortCascara(datosParaClasificar);
                } else {
                    return ordenarPorShakerSort(datosParaClasificar);
                }
            }
    ...
    private int[] ordenarPorShakerSort(int[] datosParaClasificar) {
        int largo = datosParaClasificar.length;
        int izquierda = 0;
        int derecha = largo - 1;
        int cambioIzquierda, cambioDerecha;
        
        while (izquierda < derecha) {
            cambioDerecha = 0;
            for (int i = izquierda; i < derecha; i++) {
                if (datosParaClasificar[i + 1] < datosParaClasificar[i]) {
                    intercambiar(datosParaClasificar, i, i + 1);
                    cambioDerecha = i;
                }
            }
            
            derecha = cambioDerecha;
            cambioIzquierda = largo - 1;
    ...
    protected int[] ordenarPorShakerSortCascara(int [] datosParaClasificar) {
        if (datosParaClasificar != null) {
            return datosParaClasificar;
        }
        return null;
