...
public class TClasificador {
    ...
    public static final int METODO_CLASIFICACION_CUENTA_DISTRIBUCION = 7;
     ...
     * solicitado
     */
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion, int elementoMenor, int elementoMayor) {
        switch (metodoClasificacion) {
            ...
            case METODO_CLASIFICACION_CUENTA_DISTRIBUCION:
                return ordenarPorCuentaDistribucion(datosParaClasificar, elementoMenor, elementoMayor);
            default:
    ...
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion, boolean cascara, int elementoMenor, int elementoMayor) {
        switch (metodoClasificacion) {
            case METODO_CLASIFICACION_INSERCION -> {
                if (cascara) {
            ...
            case METODO_CLASIFICACION_CUENTA_DISTRIBUCION -> {
                if (cascara) {
                    return ordenarPorCuentaDistribucionCascara(datosParaClasificar, elementoMenor, elementoMayor);
                } else {
                    return ordenarPorCuentaDistribucion(datosParaClasificar, elementoMenor, elementoMayor);
                }
            }
    ...
    protected int[] ordenarPorCuentaDistribucion(int[] datosParaClasificar, int elementoMenor, int elementoMayor) {
        return cuentaDistribucion(datosParaClasificar, elementoMenor, elementoMayor);
    }
    
    protected int[] ordenarPorCuentaDistribucionCascara(int[] datosParaClasificar, int elementoMejor, int elementoMayor) {
        if (datosParaClasificar != null) {
            return datosParaClasificar;
        } else {
            return null;
    ...
    private int[] cuentaDistribucion(int[] datosParaClasificar, int u, int v) {
...
//        }
        ...
        clasif.clasificar(vectorAleatorio, METODO_CLASIFICACION_HEAPSORT, 0, 50);
        long vFinal = System.nanoTime();

        System.out.println(vFinal - inicial);

        inicial = System.nanoTime();
        clasif.clasificar(vectorAscendente, METODO_CLASIFICACION_HEAPSORT, 0, 50);
        vFinal = System.nanoTime();

        System.out.println(vFinal - inicial);

        inicial = System.nanoTime();
        clasif.clasificar(vectorDescendente, METODO_CLASIFICACION_HEAPSORT, 0, 50);
        vFinal = System.nanoTime();
