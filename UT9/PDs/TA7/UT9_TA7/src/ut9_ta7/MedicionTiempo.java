...
public class MedicionTiempo {
    ...
    public MedicionTiempo(int tamanioVectores) {
        ...
        this.tamanioVectores = tamanioVectores;
    }
    ...
    public long medicionTiempo(int algoritmo, int tipoOrden) {
        ...
        while (total < TIEMPO_RESOLUCION) {
            ...
            clasificador.clasificar(datosCopia, algoritmo, false, 0, tamanioVectores);
        ...
        while (total < TIEMPO_RESOLUCION) {
            cantLlamadas++;
            int[] datosCopia = vectorOriginal.clone();
            clasificador.clasificar(datosCopia, algoritmo, true, 0, tamanioVectores);
            long t2 = System.nanoTime();
            total = t2 - t1;
        }
