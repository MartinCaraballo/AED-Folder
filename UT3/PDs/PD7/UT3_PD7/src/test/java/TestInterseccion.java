...
public class TestInterseccion {
    ...
    public void testInterseccion() {
        ...
        // Estan todos los elementos en un conjunto y en otro.
        assertEquals(jhonDoe, ambosCursosSimultaneo.buscar("1234").getDato());
        assertEquals(volkswagenGol, ambosCursosSimultaneo.buscar("9756").getDato());
        assertEquals(santiagoOlivera, ambosCursosSimultaneo.buscar("4712").getDato());
        assertEquals(dilanAguilar, ambosCursosSimultaneo.buscar("2787").getDato());
    }
}
