...
public class Lista<T> implements ILista<T> {
    ...
    public void retirarDuplicados() {
        ...
        Lista<T> listaSinDuplicados = new Lista<>();
        Nodo<T> nodoActual = primero;
        Nodo<T> nodoSiguiente = primero.getSiguiente();
        while (nodoActual != null && nodoSiguiente != null) {
            nodoSiguiente = nodoActual.getSiguiente();
            nodoActual.setSiguiente(null);
            if (listaSinDuplicados.buscar(nodoActual.getEtiqueta()) == null) {
                listaSinDuplicados.insertar(nodoActual);
            }
            nodoActual = nodoSiguiente;
        }
        setPrimero(listaSinDuplicados.getPrimero());
        listaSinDuplicados.setPrimero(null);
    }
