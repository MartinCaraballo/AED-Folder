...
// SEA MÁS APROPIADA
    ...
    public String imprimirEtiquetas() {
        StringBuilder resultado = new StringBuilder(origen.getEtiqueta().toString());
        otrosVertices.forEach((vertice) -> {
            resultado.append(" - ").append(vertice.toString());
        });
        resultado.append(" | Costo: ").append(costoTotal);
